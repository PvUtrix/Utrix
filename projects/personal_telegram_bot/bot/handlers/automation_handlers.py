...
class AutomationScriptExecutor:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.script_mappings = {
            ...
            "create_business_opportunity": {
                "script": "business_opportunity_manager.py",
                "args": ["create"],
            ...
            # Prosperity Course
            "prosperity_course": {
                "script": "prosperity-course-manager.py",
                "args": ["status"],
    ...
    async def execute_action(self, action: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            # Build command
            cmd = ["python3", script_path] + script_config["args"]
    ...
    def _add_parameters(self, cmd: list, action: str, params: Dict[str, Any]) -> list:
        ...
        if action == "create_opportunity" and "description" in params:
...
class AutomationHandler:
    ...
    async def show_script_status(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        categories = {
            ...
            "Daily Operations": ["daily_summary", "morning_routine", "log_health", "log_learning"],
            "System Management": ["create_backup", "gdrive_sync", "system_stats"],
            "Learning": ["prosperity_course"]
        }
